    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_cnt', models.IntegerField()),
                ...
                ('workoutInfo_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='day_history_workout_workout', to='workout.workoutinfo')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workoutInfo_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='day_history_workout', to='workout.workoutinfo')),
            ],
        ),
    ]
