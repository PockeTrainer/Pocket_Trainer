export const appointments = [
    {
      title: '클리어',
      startDate: new Date(2022, 2, 1, 9, 35),
      endDate: new Date(2022, 2, 1, 11, 30),
      id: 0,
      location: '어깨+삼두+복근',
    }, {
      title: '20.9',
      startDate: new Date(2022, 2,1,0,0),
      endDate: new Date(2022, 2, 2,0,0),
      id: 1,
      location: 'Room 1',
    }, {
      title: '가슴',
      startDate: new Date(2022, 2, 2, 9, 35),
      endDate: new Date(2022, 2, 2, 10, 30),
      id: 2,
      location: '✔클리어',
    }, {
      title: '삼두',
      startDate: new Date(2022, 2, 2, 11, 35),
      endDate: new Date(2022, 2, 2, 12, 30),
      id: 3,
      location: '✔클리어',
    }, {
      title: '20.5',
      startDate: new Date(2022, 2,2,0,0),
      endDate: new Date(2022, 2, 3,0,0),
      id: 4,
      location: 'Room 2',
    }, {
      title: 'New Brochures',
      ...
      startDate: new Date(2022, 3, 17, 11, 0),
      endDate: new Date(2022, 3, 18, 13, 30),
      id: 10,
      location: 'Room 1',
    }, {
