...
function SpecificInfoFoodsInList({food_obj}){
                            ...
                            {/* Header container */}
                                <div className="container-fluid d-flex align-items-center" style={{justifyContent:"center"}}>
                                    <div className="row">
                                        ...
                                        <h1 className="display-2 text-white">{food_obj.DESC_KOR}</h1>
                                        <Pstyled bold="etc" color="white">영양정보</Pstyled>
                                        <hr style={hrStyle}></hr>
                                        <Pstyled bold="lighter" color="white">제품명:{food_obj.DESC_KOR}</Pstyled>
                                        <Pstyled bold="lighter" color="white">열량:{food_obj.NUTR_CONT1}kcal(1회제공량)</Pstyled>
                                        <Pstyled bold="lighter" color="white">탄수화물:{food_obj.NUTR_CONT2}g(1회제공량)</Pstyled>
                                        <Pstyled bold="lighter" color="white">단백질:{food_obj.NUTR_CONT3}g(1회제공량)</Pstyled>
                                        <Pstyled bold="lighter" color="white">지방:{food_obj.NUTR_CONT4}g(1회제공량)</Pstyled>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default SpecificInfoFoodsInList