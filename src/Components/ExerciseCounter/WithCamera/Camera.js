...
function Camera({display}) {
    ...
    const drawCanvas = (pose, video, videoWidth, videoHeight, canvas) => {
        ...
        if(exercise_name.exercise_name === "pushup"||exercise_name.exercise_name === "bench_"||exercise_name.exercise_name === "pec_dec_fly"||exercise_name.exercise_name === "reverse_peck_deck_fly"||exercise_name.exercise_name === "squat"||exercise_name.exercise_name === "leg_press"||exercise_name.exercise_name === "squat"||exercise_name.exercise_name === "leg_extension"||exercise_name.exercise_name === "plank") {
