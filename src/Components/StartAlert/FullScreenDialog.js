...
export default function FullScreenDialog() {
  ...
  const settings = {
    initialSlide:initial_state.current==="next"?what_im_looking-1:(initial_state.current==="prev"?what_im_looking+1:0),
    arrows:false,
    dots:true,
    infinite: false,
    speed: 500,
  ...
  useEffect(()=>{
    console.log("what:"+what_im_looking);
    console.log("prev:"+prev_what.current);
    ...
    if(what_im_looking>prev_what.current){//다음슬라이드로 이동하는 버튼을 누른것을 의미
  ...
  return (
    <div>
      ...
      <Dialog
        ...
        // sx={{".MuiPaper-root":{backgroundColor:"white !important "},".MuiAppBar-root":{backgroundColor:"#5e72e4 !important"}}}
      >
